...
class DiscountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discount" do
    assert_difference('Discount.count') do
      post discounts_url, params: { discount: { fail: @discount.fail, level: @discount.level, state: @discount.state, success: @discount.success } }
    end
  ...
  test "should update discount" do
    patch discount_url(@discount), params: { discount: { fail: @discount.fail, level: @discount.level, state: @discount.state, success: @discount.success } }
